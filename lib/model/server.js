...
class ServerFolder extends _FolderClass.default {
  ...
  getChildren(directories, files) {
    let symbolicLinksAndOthers = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    if (!this.exists()) {
  ...
  /**
   * Recursively finds all the files paths inside this folder's children hierarchy.
   * @param {*} addDirectoryPath if true, the function will return absolute paths.
  ...
  getAllFilesWithContent() {
    let regex = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    let returnsFirstOnly = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  */
  getStats() {
    return this.getAllFilesWithContent().reduce((prevStatsValue, currentFile) => {
      ...
      return {
        ...
        oldest_modification_date: prevStatsValue.oldest_modification_date > fileLastModifDate ? fileLastModifDate : prevStatsValue.oldest_modification_date,
        last_modification_date: prevStatsValue.last_modification_date < fileLastModifDate ? fileLastModifDate : prevStatsValue.last_modification_date
      };
    }, {
      bytes_size: 0,
